...
export const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
        .sendForm('service_d37iqii', 'template_jrfmiug', form.current, {
            ...
            <div className='contact__content'>
                ...
                <form ref={form} onSubmit={sendEmail} className='contact__form'>
                    <div className='contact__form-div'>
                        ...
                        <input className='contact__form-input' type='text' name='name' id='name' placeholder='Enter Your Name' required/>
                    </div>
                    <div className='contact__form-div'>
                        <label className='contact__form-tag' for='email'>Email</label>
